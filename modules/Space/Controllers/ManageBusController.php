...
class ManageBusController extends FrontendController
{
    ...
    {
        parent::__construct();
        $this->spaceClass = Bus::class;
        $this->spaceTermClass = BusTerm::class;
    ...
    public function manageSpace(Request $request)
    {
        ...
        $user_id = Auth::id();
        $rows = $this->spaceClass::where("create_user", $user_id)->orderBy('id', 'desc')->with(['airline','airportTo','airportFrom','author']);
        $data = [
            'rows' => $rows->paginate(5),
            'breadcrumbs'        => [
                [
                    'name' => __('Manage Buses'),
    ...
    public function restore($id)
    {
        ...
        return redirect(route('space.vendor.recovery'))->with('success', __('Restore bus success!'));
    }
    ...
    public function store( Request $request, $id ){
        ...
        if ($res) {
            ...
            if($id > 0 ){
                ...
                return redirect(route('space.vendor.edit',['id'=>$row->id]))->with('success', __('Bus created') );
            }
        }
    }
    ...
    public function editSpace(Request $request, $id)
    {
        ...
        $row = $row->find($id);
        if (empty($row)) {
            return redirect(route('space.vendor.index'))->with('warning', __('Bus not found!'));
        }
        $data = [
            'translation'    => $row,
            'row'           => $row,
    ...
    public function deleteSpace($id)
    {
        ...
        return redirect(route('space.vendor.index'))->with('success', __('Delete bus success!'));
    }
	...
	public function cloneSpace(Request $request,$id){
		...
		try{
			...
			return redirect()->back()->with('success',__('Bus clone was successful'));
