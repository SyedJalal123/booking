<?php
    ...
    class BusSeatTypeController extends AdminController
    {
        /**
         * @var string
         */
        ...
        public function __construct()
        {
            ...
            $this->seatType = BusSeatType::class;
        }
        ...
        public function index(Request $request)
        {
            ...
            return view('Space::admin.seatType.index', $data);
        }
        public function edit(Request $request, $id)
        {
            ...
            if (empty($row)) {
                return redirect(route('space.admin.seat_type.index'));
            }
            if (!$this->hasPermission('space_manage_others')) {
            ...
            return view('Space::admin.seatType.detail', $data);
        }
        ...
        public function store( Request $request, $id ){
            ...
            $res = $row->save();
            if ($res) {
                return redirect(route('space.admin.seat_type.edit',$row))->with('success', __('Seat type saved') );
            }
        }
