...
@if(is_default_lang())
    ...
    <div class="row d-none">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Config review for bus')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="" >{{__("Enable review system for Bus?")}}</label>
                        <div class="form-controls">
                            ...
                            <br>
                            <small class="form-text text-muted">{{__("Turn on the mode for reviewing bus")}}</small>
                        </div>
                    </div>
                    <div class="form-group" data-condition="space_enable_review:is(1)">
                        <label class="" >{{__("Customer must book a bus before writing a review?")}}</label>
                        <div class="form-controls">
...
@if(is_default_lang())
    ...
    <div class="row d-none">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Config Booking for bus')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <select name="space_booking_type" class="form-control">
                                    <option value="by_day" {{($settings['space_booking_type'] ?? '') == 'by_day' ? 'selected' : ''  }}> {{__("Bus by day")}}</option>
                                    <option value="by_night" {{($settings['space_booking_type'] ?? '') == 'by_night' ? 'selected' : ''  }}> {{__("Bus by night")}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Vendor config for bus')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="" >{{__("Bus created by vendor must be approved by admin")}}</label>
                        <div class="form-controls">
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__("Disable bus module?")}}</h3>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-title"><strong>{{__("Disable bus module")}}</strong></div>
            <div class="panel-body">
                <div class="form-group">
                    <div class="form-controls">
