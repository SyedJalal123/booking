...
<div class="panel">
    <div class="panel-title"><strong>{{__("Bus Stop")}}</strong></div>
    <div class="panel-body">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        \App\Helpers\AdminForm::select2('airport_from', [
                                'configs' => [
                                        'ajax'        => [
                                                'url' => route('space.admin.bus_stops.getForSelect2'),
                                                'dataType' => 'json'
                                        ],
                                        'allowClear'  => true,
                                        'placeholder' => __('-- Select Bus Stop from --')
                                ]
                        ], !empty($jsons->id) ? [
                                $jsons->id,
                                $jsons->name . ' (#' . $jsons->id  . ')'
                    ...
                    <div class="form-group">
                        ...
                        \App\Helpers\AdminForm::select2('airport_to', [
                                'configs' => [
                                        ...
                                        'allowClear'  => true,
                                        'placeholder' => __('-- Select Bus Stop to --')
                                ]
                        ], !empty($jsons->id) ? [
                                $jsons->id,
                                $jsons->name . ' (#' . $jsons->id  . ')'
...
<div class="panel">
    <div class="panel-title"><strong>{{__("Bus Service and time")}}</strong></div>
    <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <label for="">{{__('Bus Service')}}</label>
                        <?php
                        $jsons = !empty($row->airline) ? $row->airline : false;
                        \App\Helpers\AdminForm::select2('airline_id', [
                                'configs' => [
                                        'ajax'        => [
                                                'url' => route('space.admin.bus_companies.getForSelect2'),
                                                'dataType' => 'json'
                                        ],
                                        'allowClear'  => true,
                                        'placeholder' => __('-- Select Bus Service --')
                                ]
                        ], !empty($jsons->id) ? [
                                $jsons->id,
                                $jsons->name . ' (#' . $jsons->id  . ')'
