...
@section('content')
    <form action="{{route('space.admin.bus_stops.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
        @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="lang-content-box">
                        <div class="panel">
                            <div class="panel-title"><strong>{{__("Bus Stop Content")}}</strong></div>
