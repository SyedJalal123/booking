...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{!empty($recovery) ? __('Recovery') : __("All Buses")}}</h1>
            <div class="title-actions">
                @if(empty($recovery))
                <a href="{{route('space.admin.create')}}" class="btn btn-primary">{{__("Add new bus")}}</a>
                @endif
            </div>
        </div>
                ...
                <form action="" class="bravo-form-item">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th> {{ __('Name')}}</th>
                            <th> {{ __('Code')}}</th>
                            <th> {{ __('Bus Stop From')}}</th>
                            <th> {{ __('Bus Stop To')}}</th>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                <a href="{{route('space.admin.edit',['id'=>$row->id])}}" class="dropdown-item btn btn-primary "><i class="fa fa-edit"></i> {{__('Edit')}}</a>
                                                <a href="{{route('space.admin.space.seat.index',['flight_id'=>$row->id])}}" class="dropdown-item btn btn-primary "><i class="fa fa-ticket"></i> {{__('Bus ticket')}}</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        @else
                            <tr>
                                <td colspan="7">{{__("No bus found")}}</td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
