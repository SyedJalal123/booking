        ...
        <div class="col-md-9">
            ...
            <div class="location">
                @if(!empty($row->airportFrom->name))
                    <i class="icofont-bus-alt-1" aria-hidden="true"></i>
                    {{__("Bus Stop From")}}: {{$row->airportFrom->name ?? ''}}
                    <span class="">({{display_datetime($row->departure_time)}})</span>
                @endif
            </div>
            <div class="location">
                @if(!empty($row->airportTo->name))
                    <i class="icofont-bus-alt-1 fa-rotate-90" aria-hidden="true"></i>
                    {{__("Bus Stop To")}}: {{$row->airportTo->name ?? ''}}
