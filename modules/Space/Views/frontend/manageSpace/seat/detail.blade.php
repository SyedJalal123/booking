...
@section('content')
    <h2 class="title-bar no-border-bottom">
        ...
        <div class="title-action">
            <a class="btn btn-info" href="{{route('space.vendor.seat.index',['flight_id'=>$currentFlight->id])}}">
    ...
    <div class="lang-content-box">
        <form novalidate action="{{route('space.vendor.seat.store',['flight_id'=>$currentFlight->id,'id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" class="needs-validation" method="post">
            @csrf
