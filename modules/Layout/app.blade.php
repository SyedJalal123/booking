...
<body class="frontend-page {{ !empty($row->header_style) ? "header-".$row->header_style : "header-normal" }} {{$body_class ?? ''}} @if(setting_item_with_lang('enable_rtl')) is-rtl @endif @if(is_api()) is_api @endif">
    ...
    <div class="bravo_wrap">
        ...
        @endif
        <a target="_blank" href="https://wa.link/a0xymx" class="fa fa-whatsapp p-3" id="whatsapp-icon"
        style="font-size:67px; position:fixed; z-index:1000; bottom:0; right:0; text-decoration:none;">
        </a>
        @yield('content')
